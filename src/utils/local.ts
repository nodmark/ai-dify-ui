...
const zhCN = {
  ...
  expandPreviewPanel: '展开 Markdown 预览',
  collapsePreviewPanel: '收起 Markdown 预览',
  delete: '删除',
  uploadFile: '上传文件',
...
const enUS = {
  ...
  expandPreviewPanel: 'Expand Markdown preview',
  collapsePreviewPanel: 'Collapse Markdown preview',
  delete: 'Delete',
